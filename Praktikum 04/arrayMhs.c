...
// NIM       : 18221173
// Tanggal   : 26-9-2022
// Deskripsi : Praktikum arrayMhs.c
...
//     MakeEmpty(&T);
//     ElType M1,M2,M3,M4;
//     M1=MakeMahasiswa("Naura","18221173",4.00);
//     M2=MakeMahasiswa("asep","18221173",3.00);
//     M3=MakeMahasiswa("ahtong","10221173",2.00);
//     M4=MakeMahasiswa("muthu","18221173",4.00);
//     SetEl(&T,1,M1);
//     SetEl(&T,2,M2);
//     SetEl(&T,3,M3);
//     SetEl(&T,4,M4);
//     printf("nilai naura: %.2f\n",T.TI[1].nilai);
//     printf("%.2f\n",RataRata(T));
//     TulisIsi(T);
//     printf("%.2f\n",Max(T));
//     printf("%s\n",MaxNama(T));
